...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (xpm bash-completion major-mode-icons all-the-icons all-the-icons-dired anzu dracula-theme helm helm-google company-shell doom-modeline magit minions wiki-summary vline undo-tree screenshot rainbow-mode rainbow-identifiers rainbow-delimiters popup pdf-tools nyan-mode mode-icons julia-shell font-lock+ flycheck-status-emoji flycheck-julia flycheck-clangcheck flycheck-checkbashisms excorporate emojify dna-mode company-quickhelp company-flx company-c-headers beacon async use-package)))
...
(custom-set-faces
 ...
 '(term-bold ((t (:foreground "#f1fa8c" :weight bold)))))
